...
export default function MainLayout() {
  ...
  const profile = { rating_score: 647 };
      ...
      <nav className="bg-[#1a1a2e]/90 backdrop-blur-md border-b border-white/5 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between h-12">
            <Link to="/home" className="flex items-center gap-2 font-bold text-orange-400 text-lg">
              ...
              return (
                ...
                >
                  <div className={cn(
                    ...
                    isActive ? 'bg-orange-500/20 shadow-[0_0_12px_rgba(255,107,53,0.2)]' : 'hover:bg-white/5'
                  )}>
